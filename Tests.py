import unittest
from Web_Scrapping.main import in_stock
from unittest import TestCase
from Web_Scrapping.P_Solve import reduce_directions
...
class Test(unittest.TestCase):
    def test_basic_in_stock_queries(self):
        ...
        self.assertTrue(
            ...
            '"The MooSEwood Cookbook: Recipes from Moosewood Restaurant, Ithaca, New York" is available in "food and '
            'driNk"'
        )
...
class TestSampleTestCases(TestCase):
    def test_should_handle_basic_tests(self):
        """should handle basic tests"""
        self.assertEqual(reduce_directions(["NORTH", "SOUTH", "SOUTH", "EAST", "WEST", "NORTH", "WEST"]), ["WEST"])
        self.assertEqual(reduce_directions(["NORTH", "WEST", "SOUTH", "EAST"]), ["NORTH", "WEST", "SOUTH", "EAST"])
